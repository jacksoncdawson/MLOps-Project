...
TRAIN_DATA_URI="${TRAIN_DATA_URI:-${ROOT_DIR}/pipelines/training/synthetic_data/train.csv}"
VAL_DATA_URI="${VAL_DATA_URI:-${ROOT_DIR}/pipelines/training/synthetic_data/val.csv}"
TEST_DATA_URI="${TEST_DATA_URI:-${ROOT_DIR}/pipelines/training/synthetic_data/test.csv}"
